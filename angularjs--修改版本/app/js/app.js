...
(function () {
    ...
    ModalController.$inject = ['$uibModal','$scope','$http'];

    function ModalController($uibModal,$scope,$http) {
        var vm = this;
        ...
        function activate() {
            vm.data = [];
            $http.get('server/data.json').success(function(res){
                vm.data = res;
            });

            //维修添加
            vm.openrevise = function(size,data) {
                ...
                for(var i=0;i<vm.data.length;i++){
                    if(vm.data[i].gs==data.gs){
                        vm.fgsdata.unshift(vm.data[i]);
                    }
                }

                vm.cddata=[];
                for(var j=0;j<vm.fgsdata.length;j++){
                    if(vm.fgsdata[j].fgs==data.fgs){
                        vm.cddata.unshift(vm.fgsdata[j]);
                    }
                }

                console.log(vm.cddata);
                vm.xldata=[];

                for(var k=0;k<vm.cddata.length;k++){
                    if(vm.cddata[k].cd==data.cd){
                        vm.xldata.unshift(vm.cddata[k]);
                    }
                }
                ...
                vm.cch=data.cch;
                vm.cfz=data.cfz;
                vm.jhfcsj=data.jhfcsj;
                vm.sjfcsj=data.sjfcsj;
                vm.jhddsj=data.jhddsj;
                vm.sjddsj=data.sjddsj;
                vm.tjrxm=data.tjrxm;
            };
            ...
            $scope.gsSelect = function (){
                vm.fgsdata=[];
                var len=vm.data.length;
                for(var i=0;i<len;i++){
                    if(vm.data[i].gs==vm.gs){
                        vm.fgsdata.push(vm.data[i]);
                    }
                }
            };
            $scope.fgsSelect = function (){
                vm.cddata=[];
                var len=vm.fgsdata.length;
                for(var i=0;i<len;i++){
                    if(vm.fgsdata[i].fgs==vm.fgs){
                        vm.cddata.push(vm.fgsdata[i]);
                    }
                }
            };
            $scope.cdSelect = function (){
                vm.xldata=[];
                var len=vm.cddata.length;
                for(var i=0;i<len;i++){
                    if(vm.cddata[i].cd==vm.cd){
                        vm.xldata.push(vm.cddata[i]);
                    }
                }
            };
            ...
            ModalInstanceCtrl.$inject = ['$scope', '$uibModalInstance','$http'];
            ...
            function ModalInstanceCtrl($scope, $uibModalInstance) {
                ...
                $scope.ok = function(){
                    ...
                    if(vm.revisedata){
                        $scope.$emit("revise",object,object.id);

                    }
                    else{
                        $scope.$emit("fcjh",object);}
...
(function () {
    ...
    angular
        .module('app.bootstrapui')
        .controller('ModalController2', ModalController);
...
(function () {
    ...
    angular
        .module('app.bootstrapui')
        .controller('ModalController3', ModalController);
...
(function () {
    ...
    function DashboardController($scope,$http) {
        var vm = this;
        $scope.$on("fcjh",function(event,objects){
            objects.id=vm.data2.length;
            vm.data2.unshift(objects);
        });

        $scope.$on("revise",function(event,objects,id){
            var reviselen=vm.data2.length;
            for(var i=0;i<reviselen;i++){
                if(vm.data2[i].id==id){
                    console.log("sun");
                    vm.data2[i]=objects;
                    break;
        ...
        function activate() {
            ...
            $scope.chaXun = function () {
                ...
                /*if(vm.ssjg !== undefined && vm.cph2 !== undefined) {
                    var data1 = vm.data;
                    for (var i = 0; i < data1.length; i++) {
                        var j = 0;
                        if (vm.select == "gs") {
                            if (vm.ssjg == data1[i].gs) {
                                vm.data2[j] = data1[i];
                                j++;
                            }
                        } else if (vm.select == "fgs") {
                            if (vm.ssjg == data1[i].fgs) {
                                vm.data2[j] = data1[i];
                                j++;
                            }
                        } else if (vm.select == "cd") {
                            if (vm.ssjg == data1[i].cd) {
                                vm.data2[j] = data1[i];
                                j++;
                            }
                        } else if (vm.select == "xl") {
                            if (vm.ssjg == data1[i].xl) {
                                vm.data2[j] = data1[i];
                                j++;
                            }
                        }
                ...
                }else if(vm.ssjg !== undefined && vm.cph2 == undefined){
                    var data1 = vm.data;
                    for (var i = 0; i < data1.length; i++) {
                        var j = 0;
                        if (vm.select == "gs") {
                ...
                for (var i = 0; i < data1.length; i++) {
                    if (vm.select == "gs") {
                        var countlist= data1[i].gs.split("");
                        if (vm.chaxun == data1[i].gs) {
                            //vm.data2[j] = data1[i];
                            //j++;
                            vm.data2.unshift(data1[i]);
                        }
                        else if(data1[i].gs.indexOf(vm.chaxun)>=0){
                            vm.data2.push(data1[i]);
                        }
                        else  if(list){
                            for (var k=0;k < data1[i].gs.length;k++){
                                if(countlist[k]==list[count]){
                                    count++;      }
                            }
                        ...
                        if (vm.chaxun == data1[i].fgs) {
                            vm.data2.unshift(data1[i]);
                        }
                        else if(data1[i].fgs.indexOf(vm.chaxun)>=0){
                            vm.data2.push(data1[i]);
                        }
                    } else if (vm.select == "cd") {
                        if (vm.chaxun == data1[i].cd) {
                            vm.data2.unshift(data1[i]);
                        }
                        else if(data1[i].cd.indexOf(vm.chaxun)>=0){
                            vm.data2.push(data1[i]);
                        }
                    } else if (vm.select == "xl") {
                        if (vm.chaxun == data1[i].xl) {
                            vm.data2.unshift(data1[i]);
                        }
                        else if(data1[i].xl.indexOf(vm.chaxun)>=0){
                            vm.data2.push(data1[i]);
                        }
                    } else if(vm.select == "cph"){
                        if(vm.chaxun == data1[i].cph) {
                            vm.data2.unshift(data1[i]);
                        }
                        else if(data1[i].cph.indexOf(vm.chaxun)>=0){
                            vm.data2.push(data1[i]);
                        }
                    }
                }}
...
(function () {
    ...
    function dashboardRoute(Router) {
        ...
        Router.state('app.dashboard', {
            ...
            require: ['angular-flot', 'easypiechart', 'sparkline', 'vector-map', 'vector-map-maps', 'ui.select', 'filestyle', 'angularFileUpload', 'jedate', 'datatables', 'ngTable', 'ngTableExport','xeditable']
        });
    }
...
/*
            ...
            vm.countries = [ // Taken from https://gist.github.com/unceus/6501985
                ...
                {name: 'Korea, Democratic data\'s Republic of', code: 'KP'},
                {name: 'Korea, Republic of', code: 'KR'},
                {name: 'Kuwait', code: 'KW'},
                {name: 'Kyrgyzstan', code: 'KG'},
                {name: 'Lao data\'s Democratic Republic', code: 'LA'},
                {name: 'Latvia', code: 'LV'},
            ...
            vm.multipleDemo.selectedPeople = [vm.data[5], vm.data[4]];
            vm.multipleDemo.selectedPeopleWithGroupBy = [vm.data[8], vm.data[6]];
     ...
     * "person in data | filter: {name: $select.search, age: $select.search}"
...
(function () {
    ...
    angular
        ...
        .constant('APP_REQUIRES', {
            ...
            'jedate': {
                files: ['vendor/jedate/jedate.js',
                    'vendor/jedate/jedate.min.js',
                    'vendor/jedate/skin/jedate.css']
            },
            'sparkline': {
...
(function () {
    ...
    DataTableController.$inject = ['$resource', 'DTOptionsBuilder', 'DTColumnDefBuilder', 'DTDefaultOptions','$http','$scope'];

    function DataTableController($resource, DTOptionsBuilder, DTColumnDefBuilder, DTDefaultOptions,$http,$scope) {
        var vm = this;
...
/*            DTDefaultOptions.setBootstrapOptions({
          ...
          /*  vm.data = [{
                ...
                'cch': "55",
                'cfz': "哈东站站",
                'fcsj': "2016-05-23 08：00：00",
                'jhfcsj': "2016-05-23 08：00：00",
                'sjfcsj': "2016-05-23 08：00：00",
                'ddsj': "2016-05-23 08：00：00",
                'sjyxsj': "1h",
                'tjrxm': "张三",
            },
                {
